...
class BlogPostTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.post1 = BlogPost.objects.create(
            title='Post1',
            text='This is the scription of Post1',
            status=BlogPost.STATUS_CHOICES[0][0],
            author=cls.user,
        )
        cls.post2 = BlogPost.objects.create(
            title='Post2',
            text='This is the scription of Post2',
    ...
    def test_post_detail(self):
        ...
        self.assertEqual(self.post1.text, 'This is the scription of Post1')
    ...
    def test_post_create_view(self):
        ...
        self.assertEqual(BlogPost.objects.last().text, 'this is some text')
    ...
    def test_post_update_view(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertEqual(BlogPost.objects.last().title, 'Post2 update')
        self.assertEqual(BlogPost.objects.last().text, 'this post was updated')
